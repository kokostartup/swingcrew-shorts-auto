...
4. 각 hook 위치에서 **앞뒤 30초 정도 자연스럽게 확장**해 윈도우 후보 만듦
   (P: 45~80초, B: 45~58초 — 아래 "시간" 룰 참고).
...
### 시간
- P 시리즈: 45 ≤ end_sec - start_sec ≤ 80. 목표 60~75초.
- **B 시리즈 (`26-B0XX`): 45 ≤ end_sec - start_sec ≤ 58. 목표 45~55초.**
  커버 카드 1.5초가 앞에 붙어 최종 영상이 60초를 넘기면 안 됨 (영빈 결정 2026-08-13).
