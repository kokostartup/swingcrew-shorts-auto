...
We do not sell, rent, or share collected data with third parties. The only external API the Service communicates with is TikTok's official Developer API.
...
The Service is not intended for use by individuals under 13 years of age and does not knowingly collect data from minors.

## 7. Security

We implement reasonable technical measures to protect stored credentials. However, no system is completely secure, and we cannot guarantee absolute security.
...
You may request access, correction, or deletion of your data by contacting us at davidhan.biz@gmail.com.

## 10. Contact

For privacy questions, contact: davidhan.biz@gmail.com
